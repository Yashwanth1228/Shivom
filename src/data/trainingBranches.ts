...
export const TRAINING_BRANCHES: TrainingBranch[] = [
  {
    ...
    description: "Professional dance training for beginners and advanced students in a creative and inspiring learning environment.",
    mapLink: "https://maps.app.goo.gl/zjGaNBWkVFqPTLoN9?g_st=aw",
    logo: "/assets/academy-logo.jpg",
  },
  {
    id: "branch-malagala",
    branchName: "Malagala Branch",
    academyName: "Shivom Cultural Academy",
    description: "Performance-focused dance education with expert choreography and opportunities to participate in stage performances and events.",
